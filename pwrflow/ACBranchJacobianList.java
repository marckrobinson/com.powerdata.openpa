...
public interface ACBranchJacobianList extends ACBranchExtList<com.powerdata.openpa.pwrflow.ACBranchJacobianList.ACBranchJacobian>
{
	static public class ACBranchJacobian extends com.powerdata.openpa.pwrflow.ACBranchExtList.ACBranchExt
	{
		ACBranchJacobianList _list;
		
		public ACBranchJacobian(ACBranchJacobianList list, int index)
		{
			super(list, index);
			_list = list;
		}
